    ...
    return(
      ...
      <Grid container spacing={2} sx={{display: "flex", alignItems: "center" }}>
        ...
        <Grid item xs={12} xl={6} md={6}>
          <Item sx={{backgroundColor:'transparent', boxShadow:'0'}}>
          <Item sx={{backgroundColor:'transparent', boxShadow:'0'}}>
              <Typography sx={{fontFamily:'Lato', fontStyle:'normal', fontWeight: '700', fontSize:'36px', lineHeight:'43px', textAlign:'left', color:'white'}}>
              Become an Instructor - Earn by Teaching Online at Course Cloud
              </Typography>
          </Item>
          <Item sx={{backgroundColor:'transparent', boxShadow:'0'}}>
                <Typography sx={{fontFamily:'Lato', fontStyle:'normal', fontWeight: '400', fontSize:'18px', lineHeight:'21px', textAlign:'left', color: "white"}}>
          ...
          <Item sx={{textAlign:'left', backgroundColor:'transparent', boxShadow:'0'}}>
              <Button sx={{backgroundColor:'#5193F6 !important', color:'white', height:'60px', width:'269px', fontFamily:'Lato', fontStyle:'normal', fontWeight:'500', fontSize:'18px', lineHeight:'71.5%'}}>BECOME A INSTRUCTOR</Button>
          </Item>
          </Item>
        </Grid>
      </Grid>
