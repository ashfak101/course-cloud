...
// this import commentted by Hamim (note: TS import error)
                ...
                <Link key={nav.name} href={nav.link}>
                  <a
                    style={{
                      ...
                      fontWeight: "400",
                      color: router.pathname == nav.link ? "#D19F28" : "#fff",
                    }}
                  >
                    {nav.name}
                  </a>
        ...
        <Box sx={{ width: 250, bgcolor: "#191C23", height: "100vh" }}>
          ...
          >
            <CommonButton
              fontSize=".9rem"
              textValue={!email ? "Login" : "Logout"}
              onClick={!email ? handleOpen : logOut}
            />
          </Box>
        </Box>
      </Drawer>
