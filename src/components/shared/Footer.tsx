        ...
        <Box sx={{ flexGrow: 1, paddingTop: '60px' }}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} xl={3} md={3}>
              <Typography sx={{ fontFamily: 'Lato', fontStyle: 'normal', color: 'white' }}>About</Typography>
              <Typography sx={{ fontFamily: 'Lato', fontStyle: 'normal', color: 'white' }}>Affiliate program</Typography>
              <Typography sx={{ fontFamily: 'Lato', fontStyle: 'normal', color: 'white' }}>Careers</Typography>
              <Typography sx={{ fontFamily: 'Lato', fontStyle: 'normal', color: 'white' }}>Privacy</Typography>
              <Typography sx={{ fontFamily: 'Lato', fontStyle: 'normal', color: 'white' }}>Terms</Typography>
              <Typography sx={{ fontFamily: 'Lato', fontStyle: 'normal', color: 'white' }}>Grants</Typography>
              <Typography sx={{ fontFamily: 'Lato', fontStyle: 'normal', color: 'white' }}>Groups</Typography>
              <Typography sx={{ fontFamily: 'Lato', fontStyle: 'normal', color: 'white' }}>Support</Typography>
            </Grid>
            <Grid item xs={6} xl={3} md={3}>
              <Typography sx={{ fontFamily: 'Lato', fontStyle: 'normal', color: 'white', marginLeft: '6px' }}>Social</Typography>
              <Box sx={{ display: 'flex' }}>
