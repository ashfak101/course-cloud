...
const QuizResultHeader = (props:Props) => {
  ...
  return (
    <Box sx={{background: "linear-gradient(180deg, rgba(255, 255, 255, 0.25) 51.22%, rgba(255, 255, 255, 0) 127.72%), #ED3B45",px:2,mt:2,color:"#fff", height:"50px", display: 'flex',justifyContent: 'space-between',alignItems: 'center',borderTopRightRadius:"10px",borderTopLeftRadius:"10px"}}>
