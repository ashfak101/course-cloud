...
const RecentBlogs = () => {
    return (
        ...
        <Button sx={{width:'230px', height:'60px', borderRadius:'5px', border:'1px solid white', color:'white', marginTop:'50px', fontFamily:'Lato', fontStyle:'normal', fontWeight:'500', fontSize:'18px', lineHeight:'71.5%', marginBottom:'110px'}}>READ MORE</Button>
        </Box>
        </Container>
        </>
    )
