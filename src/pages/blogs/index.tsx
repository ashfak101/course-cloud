         ...
         <Box sx={{ flexGrow: 1 }}>
          <Grid container spacing={2}>
           ...
           <Grid item xs={2} xl={1}>
            ...
            >
             <Image
              src="/assets/images/blogauthor.png"
              width={27}
              height={27}
              alt=""
             />
           ...
           <Grid item xs={12}>
            <Item sx={{ backgroundColor: "transparent", boxShadow: "0" }}>
             <Typography sx={{ textAlign: "left", color: "white" }}>
              Certificate in British Sign Language Course Overview If you want
              to broad up your experiences and development in communication
              throug, If you want to broad up your experiences and development
